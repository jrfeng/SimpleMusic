...
public interface MusicStorage {
    String MUSIC_LIST_ALL = "all";
    String MUSIC_LIST_I_LOVE = "i_love";
    String MUSIC_LIST_RECENT_PLAY = "recent_play";
     ...
     * @param listName 歌单名称。
     */
    void addMusicToList(Music music, String listName);
     ...
     * @param listName 歌单名称。
     */
    void removeMusicFromList(Music music, String listName);
     ...
     * @param music 最近播放的音乐。
     */
    void recordRecentPlay(Music music);
     ...
     * @param music 要移除的音乐。
     */
    void removeMusicFromAllMusicList(Music music);
