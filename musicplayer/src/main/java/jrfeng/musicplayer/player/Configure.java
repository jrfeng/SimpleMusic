...
public class Configure {
    private static Class mMusicStorageCL;
    ...
    public static void decode(Context context) throws XmlPullParserException, IOException, ClassNotFoundException {
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (nodeName.equalsIgnoreCase("music-provider")) {
                    musicStorage = parser.nextText();
                } else if (nodeName.equalsIgnoreCase("pending-activity")) {
    ...
    public static Class getMusicStorageClass() {
